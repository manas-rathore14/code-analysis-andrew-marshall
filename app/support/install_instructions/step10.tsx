...
export default function Step10Screen() {
  ...
  const navigateToNextStep = () => {
    router.push('/support/install_instructions/step11');
  };
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Animated.View entering={FadeInUp.delay(200)}>
          <Text style={styles.title}>Powering on the Chiller</Text>
          <Text style={styles.description}>
            Follow this sequence to safely start your chiller system:
          </Text>
          <Text style={styles.description}>
            Startup procedure:
            ...
            {'\n'}- Wait for system self-check
            {'\n'}- Confirm pump operation
            {'\n'}- Listen for normal operating sounds
            {'\n'}- Watch for error indicators
          </Text>
          <Text style={styles.description}>
            Important: If you notice any unusual sounds or error messages, power off immediately and consult the troubleshooting guide.
          </Text>
        </Animated.View>
